...
#         # 处理kernel_size参数 - 关键修复
#         if isinstance(k, (tuple, list)):
#             # 如果k是元组或列表，取第一个值或检查是否为方形核
...
#         # 确保所有参数都有有效值，避免None值传递给PyTorch
#         c1 = int(c1) if c1 is not None else 1
#         c2 = int(c2) if c2 is not None else 1
...
#                 device=None  # 让PyTorch自动选择device
#             )
#         except TypeError:
#             # 如果上面的方法不行，使用旧版本兼容的方式
